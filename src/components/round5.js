...
import { quiz5 } from '../helpers/preguntas';
...
export const Round5 = () => {
    ...
    const quiz = quiz5.filter((val) => val.id === puesto)
    ...
    const enviar = () => {
        ...
        if (total === 5) {
            ...
            localStorage.setItem("premio5", JSON.stringify({
        ...
        return (
            <div className='text-center pt-2'>
                <div className='w-50 mt-4 mx-auto'>
                    <img className='gameover' src='https://res.cloudinary.com/donoutoby/image/upload/v1654765114/23540651560279721_hnapet.jpg' alt='fin del round 1' />
                    <h1>Has sobrevivido al round 5</h1>
                    <p>felicidades lograste sobrevivir al cuarto round, estas que arders has logrado derrotar el round final, tienes totalmente merecido este premio (has desbloquedo el personaje final)<br /><br />
                        <br />
                        att: "lord kitsune" </p>
                    <table className="table continuar">
                        <thead>
                            <tr>
                                <th scope="col">Ir a Trofeos</th>
                                <th scope="col"><Link className='option' to="/score">Si</Link></th>
                                <th scope="col">/</th>
                                <th scope="col option"><Link className='option' to="/">No</Link></th>
                            </tr>
                        </thead>
