...
export const Game = () => {
    ...
    const quiz = quiz1.filter((val) => val.id === puesto)
        ...
        return (
            <div className='text-center pt-2'>
                <div className='w-50 mt-4 mx-auto'>
                    <img className='gameover' src='https://res.cloudinary.com/donoutoby/image/upload/v1654765114/i554446_klj8oy.webp' alt='fin del round 1' />
                    <h1>Has sobrevivido al round 1</h1>
                    <p>felicidades lograste sobrevivir al primer round,
                        como recompensa por llegar hasta aqui has desbloqueado un personaje de esta mitica saga,
                        puedes ir a ver tu premio en la seccion de trofeos</p>
                    <table className="table continuar">
                        <thead>
                            <tr>
                                <th scope="col">Continuar</th>
